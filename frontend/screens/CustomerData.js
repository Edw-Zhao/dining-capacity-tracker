...
import { StyleSheet, Text, View, TouchableHighlight, Alert, Image, ScrollView, TouchableOpacity } from "react-native";
  ...
  return (
    <View style={styles.container}>
      <View style={{ width: "100%" }}>
        ...
        {dataLoaded && filterCounter === 0 && (
          <ScrollView contentContainerStyle={styles.containerScroll}>{displayAllData()}</ScrollView>
        )}
        {filterCounter > 0 && (
